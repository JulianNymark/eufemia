...
/**
 * Dialog tests
 * - Dialog appears on triggerbutton
 * - Dialog can handle close by callback
 * - Check that global context works
 * - Has support for nested dialogs
 * - Can have custom dialog content (the parts)
 *
 * - ARIA test
 * - Component snapshot
 * - CSS snapshot test
